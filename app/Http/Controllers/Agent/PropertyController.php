...
class PropertyController extends Controller
{
    ...
    { 
        ...
        if(isset($image)){
            ...
            $propertyimage = Image::make($image)->save($imagename, 90);
        ...
        if(isset($floor_plan)){
            ...
            $propertyfloorplan = Image::make($floor_plan)->save($imagefloorplan, 90);
        ...
        if($gallary)
        {
            foreach($gallary as $images)
            {
                ...
                $propertyimage = Image::make($images)->save($galimage, 90);
